...
## Table of Contents
* [What Listman.io Is For](#what-listmanio-is-for)
* [What Listman.io Is Not For](#what-listmanio-is-not-for)
...
* [Understanding Free vs Business Plan](#understanding-free-vs-business-plan)
  + [How to Subscribe to Business Plan](#how-to-subscribe-to-business-plan)
* [Create SharePoint Application (App-Only aka Application Context Principal)](#create-sharepoint-application--app-only-aka-application-context-principal-)
* [Test Connection To SharePoint](#test-connection-to-sharepoint)
...
## Download the App
> By Downloading The App or Signing Up you are agree to the [Terms Of Service](https://www.listman.io/kb/tos).
